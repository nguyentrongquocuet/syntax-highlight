(() => {
  ...
  var spec_Identifier = { __proto__: null, given: 42, and: 50, or: 50, not: 50, is: 50, when: 52, end: 54 };
  var parser = LRParser.deserialize({
    ...
    nodeNames: "\u26A0 Program GivenExpression Given Identifier DecContent Word BinaryCompare ConDec ConDec1 StartDec NewLine EndDec ConDec2",
    maxTerm: 28,
    skippedNodes: [0],
    repeatNodeCount: 5,
